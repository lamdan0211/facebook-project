      ...
      <header className="fixed top-0 left-0 right-0 bg-white shadow-md p-2 flex items-center justify-between z-40 h-14 relative">
         ...
         <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <div className="flex items-center justify-between w-[180px]">
               ...
               {/* Video Icon */}
               <Link href="/watch" className="flex items-center justify-center px-2 md:px-9 py-2 md:py-1 rounded-lg hover:bg-gray-200 cursor-pointer text-gray-500 hover:text-gray-700 h-[55px]">
                ...
                {/* Friends Icon */}
                <Link href="/friends" className="flex items-center justify-center px-2 md:px-9 py-2 md:py-1 rounded-lg hover:bg-gray-200 cursor-pointer text-gray-500 hover:text-gray-700 h-[55px]">
                <UsersRound />
               </Link>
            </div>
         </div>
