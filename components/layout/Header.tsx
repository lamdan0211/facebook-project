   ...
   return (
      <header className="fixed top-0 left-0 right-0 bg-white shadow-md p-2 flex items-center justify-between z-10 h-14">
         ...
         <div className="flex items-center flex-grow-0 mr-4">
            ...
            <div className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-2xl min-w-[40px] mr-2">f</div>
            {/* Search Bar */}
         ...
         <div className="flex items-center justify-center flex-1 space-x-2 md:space-x-1">
            {/* Home Icon (Active) */}
            <div className="flex items-center justify-center flex-1 md:flex-none md:w-auto px-2 md:px-4 py-2 md:py-1 rounded-lg cursor-pointer border-b-2 border-blue-600 text-blue-600">
            ...
            {/* Video Icon */}
            <div className="flex items-center justify-center flex-1 md:flex-none md:w-auto px-2 md:px-4 py-2 md:py-1 rounded-lg hover:bg-gray-200 cursor-pointer text-gray-500 hover:text-gray-700">
